...
<html>
<head>
<title>MY FIRST STATIC WEB PAGE ON HEROKU</title>
<meta charset="UTF-8">
...
<div class="w3-top">
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    <a href="#home" class="w3-bar-item w3-button"><b>BR</b> Architects ( check 1997 )</a>
...
<div class="w3-content w3-padding" style="max-width:1564px">
  ...
  <div class="w3-container w3-padding-32" id="about">
    ...
    <?php 
      echo date('Y-m-d');
    ?>
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">About - MY Family 22222git Main ()  </h3>
  ...
  <div class="w3-container w3-padding-32" id="contact">
    <h3 class="w3-border-bottom w3-border-light-grey w3-padding-16">Contact 22</h3>
